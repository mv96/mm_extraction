...
def preload(embeddings_name, input_path=None, registry_path=None):
    ...
    embeddings = Embeddings(
        embeddings_name, resource_registry=resource_registry, load=False
    )
    ...
    if input_path is None:
        ...
        if (
            ...
            print(
                "Embeddings resource is not specified in the embeddings registry:",
                embeddings_name,
            )
    else:
